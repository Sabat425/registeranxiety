...
function updateCart() {
    ...
    const cartCount1 = document.querySelector('.cart-count1');
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const mobileCartBtn = document.querySelector('.cart-icon1');
    if (mobileCartBtn) {
...
document.addEventListener('DOMContentLoaded', () => {
  //  const menuIcon = document.querySelector('.menu-icon');
   ...
   /* const cartModal = document.querySelector('.cart-modal');
    ...
    if (mobileCartBtn) {
        mobileCartBtn.addEventListener('sclick', (e) => {
            e.preventDefault();
...
function updateCartCount(count) {
    ...
    cartCount1.classList.add('updating');
    cartCount.textContent = count;
    cartCount1.textContent = count;
    setTimeout(() => cartCount.classList.remove('updating'), 500);
    setTimeout(() => cartCount1.classList.remove('updating'), 500);
}
...
// Update click handlers for both cart icons
